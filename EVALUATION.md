...
A draft output is grounded if every factual claim it makes can be traced back to a retrieved chunk from one of the four source documents. An ungrounded claim is one the system invented without evidence — a hallucination.
